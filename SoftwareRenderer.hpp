...
class SoftwareRenderer {
	...
	private:
		...
		void DrawTriangleFlat(Math::Vector3 p1, Math::Vector3 p2, Math::Vector3 p3);
		void DrawTriangleFlatBottom(Math::Vector3& p1, Math::Vector3& p2, Math::Vector3& p3);
		void DrawTriangleFlatTop(Math::Vector3& p1, Math::Vector3& p2, Math::Vector3& p3);
